...
var nextnodebroadcasttopic = config.nextnode+'/control';
...
var kubectlproxy = config.globalsettings.kubectlproxy.split(":");
var namespace = config.globalsettings.namespace;
